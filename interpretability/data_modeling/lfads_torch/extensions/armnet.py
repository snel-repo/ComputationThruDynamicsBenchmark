...
class ActivationR2(pl.Callback):
    ...
    def on_validation_epoch_end(self, trainer, pl_module):
        ...
        for s in sessions:
            ...
            # Compute R2 between mean and recon_data
            r2 = r2_score(
                recon_data.reshape(-1, neur_recon),
                means.reshape(-1, neur_recon),
                multioutput="uniform_average",
            )
            metrics = {f"act_R2/r2_{s}": r2}
            # Log the figure
            pl_module.log_dict(
                {
                    **metrics,
